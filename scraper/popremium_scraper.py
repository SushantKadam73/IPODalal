...
async def scrape_popremium():
    ...
    async with async_playwright() as p:
        ...
        table_selector = "body > div > div > section.content > div:nth-child(5) > div > div > div.box-body.no-padding.table-responsive > table"
